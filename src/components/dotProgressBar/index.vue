  ...
  watch: {
    i() {
      this.$nextTick(() => {
        ...
        this.rendition.themes.fontSize(FONT_SIZE_LIST[this.i]['fontSize'])
      })
    }
  },
  mounted() {
    this.i = getEbookLocalStorage(this.fillName + '-info', 'fontListNumber') || this.defaultFontSizeListNumber
  }
})
</script>
